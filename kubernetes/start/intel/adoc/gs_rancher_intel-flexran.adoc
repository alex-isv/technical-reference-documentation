...
// Alex: Can we use an approved logo lock-up here?
...
// Alex: Who is this guide for and what skills are needed?
...
The servers used for the development of this guide have the following specifications:
...
// Alex: Is this image necessary?
image::eth1.png[networking components, scaledwidth="75%", align="center"]

[NOTE]
====
For more details on server components, see _Installation Guide Software Release v22.07 (Doc. No.: 575834-15.0)_ and _FlexRAN™ 5GNR Reference Solution 22.07 - PHY Software Documentation (Doc. No.:603577)_.
====
...
// Alex: Can these screenshots be replaced with text guidance?
